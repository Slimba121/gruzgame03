...
export default function Home() {
  ...
  return (
    <main className={styles.container}>
      ...
      <div className={styles.brickLayer} />
      ...
      <section className={styles.card}>
        ...
        {view === "tap" && (
          <div className={styles.viewBlock}>
            <button className={styles.heroineButton} type="button" onClick={handleTap} disabled={!state || isBusy || !isCorrectChain}>
              <span className={styles.heroineIcon}>💃</span>
              <span className={styles.heroineCaption}>ТАПАЙ ГЕРОИНЮ</span>
            </button>
